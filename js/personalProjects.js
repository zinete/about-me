...
const personalProjects = [
  {
    ...
    status: '',
    description: '这是一款基于Node.js后端和UniApp前端开发的跨平台应用，一套代码同时支持H5网页版和微信小程序。项目针对剑桥少儿英语考级特点，设计了智能单词记忆系统，采用艾宾浩斯遗忘曲线算法优化复习计划。实现了音频识别打分功能，可以帮助孩子纠正发音。后台使用MySql存储学习数据，通过数据分析为家长提供学习报告，有效提升了考级通过率。',
  },
  {
    name: '基于AI大模型的健康咨询助手',
    url: 'https://net-status.nuxt.dev/ai-chat',
    urlText: 'https://net-status.nuxt.dev/ai-chat',
    status: '',
